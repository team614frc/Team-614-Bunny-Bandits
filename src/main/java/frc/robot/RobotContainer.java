...
import frc.robot.commands.Manipulator.SimpleIntake;
...
public class RobotContainer {
  ...
  //     new SwerveSubsystem(new File(Filesystem.getDeployDirectory(), "swerve/swerve"));
  ...
  private void configureBindings() {
    if (DriverStation.isTest()) {
      ...
      // SmartDashboard.getBoolean(null, false)

      driverXbox.x().whileTrue(new SimpleIntake(0.25));
